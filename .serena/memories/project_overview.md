...
- Completed baseline: platform foundation, Data Architecture v1, and Core Vote Transaction & HTTP API v1
- Current next task: Issue Read API & Seed Pipeline v1
...
Before implementing a domain feature, identify its Decision IDs, invariants, event contract, and rollback behavior. For vote work, read `mem:data_architecture_v1` and `mem:core_vote_transaction_v1`.
