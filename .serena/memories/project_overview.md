...
- Completed baseline: platform foundation, Data Architecture v1, Core Vote Transaction v1, and Issue Read API & Development Seed v1
- Current next task: Web Guest Vote Flow v1
...
Before implementing a domain feature, identify its Decision IDs, invariants, event contract, and rollback behavior. For vote work, read `mem:data_architecture_v1`, `mem:core_vote_transaction_v1`, and `mem:issue_read_seed_v1`.
