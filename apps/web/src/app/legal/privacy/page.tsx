    ...
    >
      <article className={styles.document}>
        ...
        <p>
          ...
          프로필과 관심사를 삭제하고 모든 로그인 세션을 무효화합니다. 작성한 질문·투표·댓글·반응은
          결과 통계와 대화 맥락을 유지하기 위해 계정과 분리하여 “탈퇴한 사용자” 기록으로 익명
          보관합니다. 법령상 보존 의무가 있거나 분쟁·부정 이용 대응이 필요한 기록은 필요한 기간만
          분리 보관한 뒤 파기합니다. 검증·재설정 토큰은 해시로 저장하며 만료 또는 사용 시
          무효화됩니다. 서비스 백업에 남은 정보는 백업 보존 주기에 따라 순차적으로 삭제됩니다.
        </p>
