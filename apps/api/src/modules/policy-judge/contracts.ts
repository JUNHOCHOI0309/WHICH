...
export const POLICY_JUDGE_PROFILE = "which-luna-review-v6";
// Provider scores are routing signals, not probabilities. This narrow ceiling only
// resolves a Luna-only false positive when every other publication field is clear.
export const POLICY_JUDGE_LOW_SEXUAL_CONSENSUS_MAX_SCORE = 0.01;
